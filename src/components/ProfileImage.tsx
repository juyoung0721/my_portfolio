...
export default function Profile(){
    return (
        <div className="flex flex-col items-center mt-[100px]">
            ...
            <h1 className="mt-10 text-[40px] font-extrabold text-darkbrown">
                Juyeong Lee | Developer
            </h1>
            <div className="mt-10 text-center text-base text-gray max-w-[800px] leading-relaxed font-poppins">
